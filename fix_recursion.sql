-- Quick fix for infinite recursion in programmed_classes RLS policies
-- Run this in the Supabase SQL Editor: https://supabase.com/dashboard/project/hwwvtxyezhgmhyxjpnvl/sql/new
