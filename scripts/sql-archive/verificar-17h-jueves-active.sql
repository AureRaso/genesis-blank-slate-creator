-- =====================================================
-- Verificar alumnos ACTIVOS con clases jueves 17:00
-- Para comparar con los 5 mensajes enviados
-- =====================================================
...
SELECT 
  ...
  CASE 
    WHEN se.phone IS NOT NULL AND se.phone != '' THEN '✅'
    ELSE '❌'
...
WHERE cp.status = 'active'  -- Status activo
