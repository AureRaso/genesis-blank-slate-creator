-- Función correcta con los campos reales de programmed_classes

DROP FUNCTION IF EXISTS get_student_classes_today(TEXT);
...
SELECT * FROM get_student_classes_today('mark@gmail.com');
