...
-- SOLO AFECTA A NUEVAS INSCRIPCIONES (NO RETROACTIVO)
-- =====================================================
...
-- FIN DE LA MIGRACIÓN
-- =====================================================
-- NOTA: Este script NO genera pagos para inscripciones
-- existentes. Solo afectará a nuevas inscripciones
-- creadas a partir de ahora.
-- =====================================================
