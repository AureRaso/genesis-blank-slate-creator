        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            {currentStep === 1 && <div className="space-y-6">
                ...
                field
                  ...
                  field
                    ...
                    {watchedValues.level_format === "levante" && <FormField control={form.control} name="levante_level" render={({
                  field
                }) => <FormItem>
                            <FormLabel>Nivel 
                  </FormLabel>
                ...
                <FormField control={form.control} name="selected_days" render={() => <FormItem>
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                        {DAYS_OF_WEEK.map(day => <div key={day.value} className="flex items-center space-x-2">
                            <Checkbox id={`day-${day.value}`} checked={watchedValues.selected_days?.includes(day.value as any)} onCheckedChange={checked => handleDaySelection(day.value, checked as boolean)} />
            ...
            {currentStep === 3 && <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <FormField control={form.control} name="max_students" render={({
                field
              }) => <FormItem>
                ...
                field
                        ...
                        <FormControl>
                          <Input type="number" min="1" {...field} onChange={e => field.onChange(e.target.value ? parseInt(e.target.value) : undefined)} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>} />
                </div>

                <FormField control={form.control} name="price_per_student" render={({
              field
            }) => <FormItem>
            ...
            <div className="flex justify-between pt-6">
              ...
              {currentStep < 3 ? <Button type="button" onClick={nextStep}>
                ...
                </Button> : <Button type="submit" disabled={createTemplateMutation.isPending || createScheduleMutation.isPending}>
