    ...
    <div className={`space-y-2 ${className}`}>
      ...
      <div className="flex gap-0 relative">
        ...
        <Select value={countryCode} onValueChange={handleCountryChange}>
          <SelectTrigger className="h-12 w-[85px] rounded-r-none border-r-0 border-slate-200 focus:border-playtomic-orange focus:ring-playtomic-orange/20 focus:ring-2 bg-slate-50">
